...
place1 = Place.new(name: "Allianz Parque", location: "Allianz Parque", description: "excelente", price: 1000, rating: 5, user: user4)
...
place2 = Place.new(name: "Itaquerão", location: "Neo Química Arena", description: "ruim", price: 100, rating: 2, user: user1)
...
place3 = Place.new(name: "Morumbi", location: "Estádio do Morumbi", description: "péssimo", price: 200, rating: 1, user: user3)
...
place4 = Place.new(name: "Canindé", location: "Estádio do Canindé", description: "velho", price: 50, rating: 3, user: user2)
...
place5 = Place.new(name: "Sesc Pompéia", location: "Sesc Pompéia", description: "lindo", price: 40, rating: 5, user: user5)
...
place6 = Place.new(name: "Sesc Pinheiros", location: "Sesc Pinheiros", description: "feio porém bom", price: 40, rating: 4, user: user5)
...
place7 = Place.new(name: "Casa de Francisca", location: "Rua Quintino Bocaiúva, 22 - Sé", description: "descolado", price: 70, rating: 5, user: user6)
...
place8 = Place.new(name: "Canto da Ema", location: "Avenida Brigadeiro Faria Lima, 364 - Pinheiros", description: "animado", price: 30, rating: 3.5, user: user6)
...
place9 = Place.new(name: "Espaço Unimed", location: "Rua Tagipuru, 795 - Barra Funda", description: "ruim", price: 90, rating: 2.5, user: user3)
...
place10 = Place.new(name: "Teatro Municipal", location: "Teatro Municipal de São Paulo", description: "ótimo", price: 50, rating: 4.5, user: user2)
